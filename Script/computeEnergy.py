...
def simplePendulumEnergy(q, par):
    '''Computes total energy of the simple pendulum system'''
...
def doublePendulumEnergy(q, par):
    '''Computes total energy of the double pendulum system'''
...
def triplePendulumEnergy(q, par):
    '''Computes total energy of the triple pendulum system'''
